...
Формат ввода
В первой строке задано общее число запросов к таблице n (1 <= n <= 10^5). В следующих n строках даны запросы. Запросы бывают трех видов: get, put, delete, как описано в условии.
